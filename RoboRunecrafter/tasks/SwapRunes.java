...
public class SwapRunes extends Node{

    @Override
    public boolean activate()
    {
            //Condition:
            return RoboRunecrafter.util.Resources.depositRunesGetEssence == true
    ...
    //Code to execute:
		...
		if (RoboRunecrafter.util.Resources.depositRunesGetEssence = true) {
			Camera.turnTo(BOOTH);
			BOOTH.interact("Bank");
		...
		if (Inventory.contains(RoboRunecrafter.util.Resources.ESSENCE_ID) && !Inventory.contains(RoboRunecrafter.util.Resources.RUNE_ID)) {
			Task.sleep(1000, 1500);
			RoboRunecrafter.util.Resources.depositRunesGetEssence = false;
